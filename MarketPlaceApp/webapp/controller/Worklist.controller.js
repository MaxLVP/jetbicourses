...
sap.ui.define([
		...
		"zjblessons/MarketPlaceApp/model/formatter",
		"sap/ui/model/Filter",
		...
		return BaseController.extend("zjblessons.MarketPlaceApp.controller.Worklist", {
			...
			onPressSayHello : function () {
				//Event for button SayHello
				var oButton = this.getResourceBundle();
				MessageToast.show(oButton.getText("tMessageText"));
			},
