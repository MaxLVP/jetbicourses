sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/MarketPlaceApp/app", ".html");
		...
		return Opa5.extend("zjblessons.MarketPlaceApp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/MarketPlaceApp/localService/mockserver"], function (mockserver) {
